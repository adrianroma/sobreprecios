...
use SussexDev\Simple\Api\Data\DataSearchResultsInterfaceFactory;
use SussexDev\Simple\Model\ResourceModel\Data as ResourceData;
use SussexDev\Simple\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \SussexDev\Simple\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
     ...
     * @return \SussexDev\Simple\Api\Data\DataSearchResultsInterface
     */
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        /** @var \SussexDev\Simple\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \SussexDev\Simple\Model\ResourceModel\Data\Collection $collection */
